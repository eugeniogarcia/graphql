...
`server.installSubscriptionHandlers(httpServer)` incorpora el soporte para websockets. Sustituimos _app.listen_ por _httpServer.listen_

## Arrancar Servidor Apollo
